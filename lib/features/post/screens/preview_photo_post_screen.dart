...
class PreviewPhotoPostScreen extends ConsumerStatefulWidget {
  final List<File> images;
  final File firstImage;
  const PreviewPhotoPostScreen(
      {super.key, required this.images, required this.firstImage});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _PreviewPhotoPostScreenState();
}

class _PreviewPhotoPostScreenState
    extends ConsumerState<PreviewPhotoPostScreen> {
                                ...
                                child: AspectRatio(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      ...
                                      image: FileImage(widget.firstImage),
                                    )),
                                  ),
                                ),
                              ),
