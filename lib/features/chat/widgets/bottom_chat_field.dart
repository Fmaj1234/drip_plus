...
import 'package:drip_plus/features/chat/widgets/message_reply_preview.dart';
...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  void selectGIF() async {
    ...
    if (gif != null) {
      ref.read(chatControllerProvider.notifier).sendGIFMessage(
            context,
            gif.url,
            widget.recieverUserId,
            widget.isGroupChat,
              ...
              Expanded(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    filled: true,
                    fillColor: Pallete.anotherGreyColor,
                    prefixIcon: Padding(
